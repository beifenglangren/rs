	...
	var Mapplic = function() {
		...
		function Tooltip() {
			...
			this.init = function() {
				...
				this.image = $('<background>').addClass('mapplic-tooltip-image').hide().appendTo(this.el);
		...
		function Minimap() {
			...
			this.addLayer = function(data) {
				...
				$('<background>').attr('src', data.minimap).addClass('mapplic-minimap-background').appendTo(layer);
				$('<div></div>').addClass('mapplic-minimap-overlay').appendTo(layer);
				$('<background>').attr('src', data.minimap).addClass('mapplic-minimap-active').appendTo(layer);
			}
		...
		function Sidebar() {
			...
			this.addCategories = function(categories) {
				...
				$.each(categories, function(index, category) {
					...
					if (category.icon) $('<background>').attr('src', category.icon).addClass('mapplic-list-thumbnail').prependTo(link);
			...
			this.addLocation = function(data) {
				...
				if (data.thumbnail) $('<background>').attr('src', data.thumbnail).addClass('mapplic-list-thumbnail').appendTo(link);
				...
				$.each(data.levels, function(index, value) {
					...
					switch (extension) {
						...
						case 'jpg': case 'jpeg': case 'png': case 'gif':
							$('<background>').attr('src', source).addClass('mapplic-map-image').appendTo(layer);
							break;
