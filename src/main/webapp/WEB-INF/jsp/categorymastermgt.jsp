...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 20px">
            ...
            <form class="layui-form" action="../category/categorymastersearch" method="post">
                <div class="layui-form-item">
                    <label class="layui-form-label">搜索</label>
                    <div class="layui-input-block">
                        <input type="text" name="keyword" id="keyword" placeholder="分类" autocomplete="off" class="layui-input">
            ...
            <button style="margin-top: 10px" class="layui-btn layui-btn-warm" onclick="databasebackup();">分类数据备份</button>
            <span class="layui-breadcrumb" lay-separator="|">
                 <a href="../category/categorymastermgt">全部</a>
</span>
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td><img src="../img/${category.categoryImg}" width="50px" height="50px"></td>
                    <td>
                        <a href="../category/toeditcategorymaster?categoryId=${category.categoryId}" class="layui-btn layui-btn-warm">编辑</a>
                        <a href="../category/deletecategorymaster?categoryId=${category.categoryId}" class="layui-btn layui-btn-warm" onclick="return confirm('确定将此分类删除？')">删除</a>
                    </td>
                </tr>
                </c:forEach>
                </tbody>
            ...
            <div style="display: none" id="div1">
                <form class="layui-form" action="../category/addcategorymaster" method="post" id="form1" onsubmit="return checkname();" enctype="multipart/form-data">
                    <div class="layui-form-item">
                        <label class="layui-form-label">名称</label>
                        <div class="layui-input-block">
                            <input type="text" id="categoryName" name="categoryName" autocomplete="off" class="layui-input" required  lay-verify="required">
                        </div>
                    </div>
                    <div class="layui-form-item">
...
<script>
    ...
    function check(){
        ...
        $.get(
            "http://localhost:8080/rs/category/checkmastername",
            {"name":name},
            function (result) {
                if("success"==result){
                    a=0;
    ...
    function databasebackup() { $.ajax({
        url: "${pageContext.request.contextPath}/category/databasebackupmaster",
        type: "post",
        datatype: "json",
