    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px">
            <form class="layui-form" action="../shop/search" method="post">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="keyword" id="keyword" placeholder="餐品或店家" autocomplete="off"
                               class="layui-input">
            ...
            <span class="layui-breadcrumb" lay-separator="|">
                     <a href="../shop/sort?sort=3${page.param}">人均&#8595;</a>
                     <a href="../shop/sort?sort=2${page.param}">好评&#8595;</a>
                     <a href="../shop/sort?sort=1${page.param}">销量&#8595;</a>
</span>
            </div>
            <c:forEach items="${shoplist}" var="shop">
            <a href="../product/list?shopId=${shop.shopId}">
                <div class="shoplist">
                    <div>
