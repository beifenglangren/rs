...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 20px">
            ...
            <form class="layui-form" action="../category/editinnercategory" method="post" id="form1" onsubmit="return checkname();">
                <input type="hidden" value="${category.categoryId}" name="categoryId" id="categoryId">
                <input type="hidden" value="${category.shopId}" name="shopId" id="shopId">
...
<script>
    ...
    function check(){
        ...
        $.get(
            "http://localhost:8080/rs/category/checkeditname",
            {"name":name,"categoryId":categoryId,"shopId":shopId},
            function (result) {
                if("success"==result){
                    a=0;
                }
