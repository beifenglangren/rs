    ...
    <div class="layui-body">
        ...
        <div style="padding: 20px">
            ...
            <div style="margin: 10px 0px">
                <form class="layui-form" action="../shop/searchshopcollect" method="post">
                    <div class="layui-form-item">
                        <label class="layui-form-label">搜索</label>
                        <div class="layui-input-block">
                            <input type="text" name="keyword" id="keyword" placeholder="收藏信息" autocomplete="off" class="layui-input">
            ...
            <button style="margin-top: 10px" class="layui-btn layui-btn-warm" onclick="databasebackup();">收藏数据备份</button>
            <table class="layui-table">
                ...
                <tbody>
                <c:forEach items="${shopCollectList}" var="shopcollect">
                <tr>
                    <td>${shopcollect.user.userUsername}</td>
                    <td>${shopcollect.shop.shopName}</td>
                    <td>
                        <a href="../shop/deleteshopcollect?id=${shopcollect.id}" class="layui-btn layui-btn-warm" onclick="return confirm('确定将此收藏删除？')">删除</a>
                    </td>
                </tr>
                </c:forEach>
                </tbody>
...
<script>
    ...
    function databasebackup() { $.ajax({
        url: "${pageContext.request.contextPath}/shop/databasebackup",
        type: "post",
        datatype: "json",
