        ...
        <section id="content">
            <div class="admin-form theme-info mw500" id="login">
                <div class="content-header">
                    <h1> 订餐系统</h1>
                    <p class="lead">欢迎使用订餐系统</p>
                </div>
                <div class="panel mt30 mb25">
                    <form action="../user/login" method="post" id="contact">
                        ...
                        <div class="panel-footer clearfix">
                            ...
                            <a href="../user/toregister">
                                <input type="button" id="11" value="注册" class="button btn-primary mr10 pull-right">
                            </a>
                        </div>
                    </form>
                </div>
