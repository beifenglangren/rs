...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <c:choose>
            <c:when test="${(orderMaster.orderStatus==0||orderMaster.orderStatus==1)&&(user.userIdentity==0&&user.userIdentity==2)}">
                <form class="layui-form" action="../order/updatedesc">
                    <div class="layui-form-item layui-form-text">
                        <label class="layui-form-label">备注：</label>
                        <div class="layui-input-block">
                            <textarea name="desc" id="desc" class="layui-textarea">${orderMaster.orderInfo}</textarea>
                        </div>
                    </div>
                    <input type="hidden" value="${orderMaster.orderId}" id="orderId" name="orderId">
                    <div class="layui-form-item">
                        <div class="layui-input-block">
                            <button class="layui-btn layui-btn-warm" lay-submit lay-filter="formDemo" onclick="return confirm('确定修改备注？')">修改备注</button>
                        </div>
                    </div>
                </form>
            </c:when>
            <c:otherwise>
                <div class="layui-form-item layui-form-text">
                    <label class="layui-form-label">备注：</label>
                    <div class="layui-input-block">
                        <textarea name="desc" class="layui-textarea" readonly="readonly">${orderMaster.orderInfo}</textarea>
                    </div>
                </div>
            </c:otherwise>
        </c:choose>
