    ...
    <div class="layui-body">
        ...
        <div style="padding: 20px">
            ...
            <table class="layui-table">
                ...
                <tbody>
                <c:forEach items="${categoryinner}" var="category">
                <tr>
                    <td>${category.categoryName}</td>
                    <td>
                        <a href="../category/toeditinnercategory?categoryId=${category.categoryId}" class="layui-btn layui-btn-warm">编辑</a>
                        <a href="../category/deleteinnercategory?categoryId=${category.categoryId}" class="layui-btn layui-btn-warm" onclick="return confirm('确定将此分类删除？')">删除</a>
                    </td>
                </tr>
                </c:forEach>
                </tbody>
            ...
            <div style="display: none" id="div1">
                <form class="layui-form" action="../category/addinnercategory" method="post" id="form1" onsubmit="return checkname();">
...
<script>
    ...
    function check(){
        ...
        $.get(
            "http://localhost:8080/rs/category/checkname",
    ...
    function databasebackup() { $.ajax({
        url: "${pageContext.request.contextPath}/category/databasebackup",
        type: "post",
